      ...
      <CardBody className="flex flex-col gap-4">
        <Tile tone={capped ? 'warning' : unknown ? 'neutral' : 'good'} rail className="p-4">
          <div className="flex flex-wrap items-baseline gap-x-6 gap-y-2">
            <div>
              <div className="text-[12px] font-semibold text-ink-muted">Zoning allows</div>
              <div className="font-mono text-[22px] font-semibold tabular-nums text-ink">{y.farFromZoning}</div>
            </div>
            <div>
              <div className="text-[12px] font-semibold text-ink-muted">Road width allows</div>
              <div className="font-mono text-[22px] font-semibold tabular-nums text-ink">{y.farFromRoadWidth ?? '—'}</div>
            </div>
            <div>
              <div className="text-[12px] font-semibold text-ink-muted">Applied</div>
        ...
        {y.parkingSpacesRequired > 0 && y.basementLevelsNeeded > 0 ? (
          <div className="border-t border-hairline pt-3">
            <p className="m-0 mb-2 text-[12px] font-semibold text-ink-muted">
        ...
        {y.gaps.length > 0 && (
          <div className="rounded-lg bg-raised p-3 ring-1 ring-[var(--ring)]">
            <p className="m-0 flex items-center gap-1.5 text-[12px] font-semibold text-ink-muted">
